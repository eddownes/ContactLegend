...
$where = 'c.nCampaignid = "'.$_REQUEST['cid'].'" AND sf.bFollowUpMailOpen = "1" AND sf.bFollowUpMailSent = "1" AND sf.bStatus = "1"';

$tables = "campaigns as c 
			Join schedulefollowemails as sf on sf.nCampaignid = c.nCampaignid
			Join campaigncustomers as cc on cc.nCampaignCustId = sf.nCampaignCustId";

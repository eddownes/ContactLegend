    ...
    <div class="row-fluid">
        ...
        <div class="block">
            ...
            <div class="block-content collapse in">
                <div class="span12">
					<form class="" id="createCmpgn" name="createCmpgn" method="POST" action="addCampaign.php" enctype='multipart/form-data'>
						...
						<input type="file" class="" name="sCampaignCSV" id="sCampaignCSV" /></br>

						<input type="text" placeholder="Email Subject" name="sEmailSubject" id="sEmailSubject" /></br>

						<textarea name="sEmailScript" id="sEmailScript" cols="40" rows="7">Your content here.</textarea></br>
...
<script src="<?php echo $base_url;?>wysiwyg/bootstrap-wysihtml5.js"></script>
<script src="<?php echo $base_url;?>wysiwyg/wysihtml5-0.3.0.js"></script>
